...
export default function AutoPayPage() {
    ...
    const connectWallet = async () => {
        try {
            ...
            await checkWalletContract(address);
        } catch (error) {
            ...
            {!userAddress && (
                <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
                    ...
                    <button
                        ...
                        className="mt-4 bg-linear-to-r from-green-600 to-teal-600 text-white font-semibold py-3 px-6 rounded-lg hover:shadow-lg transition-all"
                    >
                        Connect MetaMask
                    </button>
                </div>
                ...
                <>
                    ...
                    <div className="flex gap-1 bg-gray-100 p-1 rounded-lg mb-6 w-fit">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                                tab === 'setup' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                            }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                                tab === 'manage' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                            }`}
                        >
